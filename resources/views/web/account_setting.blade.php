                                    ...
                                    <div class="row order-res">
                                        <div class="col-md-3 responsive">
                                            <div class="nav flex-column nav-pills nav-div" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link active navigator" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Account settings
                                                    <div class="arrow-img">
                                                        <img src="{{ asset('assets/web/image/Vector.png') }}" alt="">
                                                    </div>
                                                </a>
                                                <a class="nav-link navigator" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Order history
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="order-history-text">
                                                                        ...
                                                                        <div class="row button-responsive">
                                                                            <div class="col-md-3 col-6 padding-res">
                                                                                <div class="material">
                                                                            ...
                                                                            <div class="col-md-3 col-6 padding-res">
                                                                                <div class="material">
                                                                                    <h1 class="mt-heading mt-heading-respo">COLOUR </h1>
                                                                                    <p class="mt-text mt-heading-respo">RED</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-6 padding-res">
                                                                                <div class="material">
                                                                                    <h1 class="mt-heading mt-heading-respo">SIZE </h1>
                                                                                    <p class="mt-text mt-heading-respo">BIG</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-6 padding-res">
                                                                                <div class="res-material">
                                                                                    <h1 class="mt-heading mt-heading-respo">MOQ </h1>
                                                                                    <p class="mt-text mt-heading-respo">10 pcs</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
