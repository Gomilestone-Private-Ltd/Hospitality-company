                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="menu-right-img">
                                                                        <img src="{{asset('assets/web/image/menu-img.jpg')}}" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li id="hide" class="hoverNone"><a class="menu-sub-drop">Products by
                                                            Collection</a>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <ul>
                                                                                <li><a href="#">ARCH ASSORTMENT</a></li>
                                                                                <li><a href="#">CRESCENT SERIES</a></li>
                                                                                <li><a href="#">ARCADIAN SERIES</a></li>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <h3 class="ruby-list-heading">GUEST BATH
                                                                                ITEMS</h3>
                                                                            <ul>
                                                                                <li><a href="#">VANITY TOP ACC.</a></li>
                                                                                <li><a href="#">AMENITY DISPLAY ACC.</a>
                                                                                </li>
                                                                                <li><a href="#">BASKETS AND HAMPERS</a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        <div class="col-md-4">
