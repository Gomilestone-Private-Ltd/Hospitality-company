        ...
        <div class="container-fluid">
            <div class="main-section-box">
                ...
                <div class="add-input-box">
                    <form method="post" action="{{ route('update.product', [$getProduct->slug ?? '']) }}" id="add-inventory"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Product Name" class="form-control form-control-user"
                                        name="product_name" value="{{ $getProduct->name ?? '' }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user select2-search category" id="category"
                                        name="category">
                                        <option value="">Select Category</option>
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if ($getProduct->category_id == $category->id) selected @endif>{{ $category->name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user select2-search subcategory"
                                        id="subcategory" name="subcategory">
                                        <option value="{{ $getProduct->subCategory_id }}" selected>
                                            {{ $getProduct->getSubCategoryDetail->name ?? '' }}</option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user select2-search supersubcategory"
                                        id="category" name="supersubcategory">
                                        <option value="{{ $getProduct->sup_subCategory_id }}" selected>
                                            {{ $getProduct->superSubCategoryDetail->name ?? '' }}</option>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="Unit" type="text" placeholder="Pack"
                                        class="form-control form-control-user " name="moq"
                                        value="{{ $getProduct->moq ?? '' }}">
                                    @if ($errors->has('moq'))
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 " multiple="multiple" data-placeholder="Select a Material"
                                        style="width: 100%;" name="material[]">

                                        @foreach ($materials as $material)
                                            <option value="{{ $material->id ?? '' }}"
                                                @if (in_array($material->id, $getProduct->material_id)) selected @endif>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 sizevarientValueList" multiple="multiple"
                                        data-placeholder="Select Size" style="width: 100%;" name="size[]">
                                        @foreach ($getSizes as $getSize)
                                            <option value="{{ $getSize->id ?? '' }}"
                                                sizevarientValueName="{{ $getSize->size ?? '' }}"
                                                pricevarientValueName="{{ $getSize->price ?? '0' }}"
                                                gstvarientValueName="{{ $getSize->gst ?? '0' }}"
                                                @if (in_array($getSize->id, $getProduct->size_id)) selected @endif>
                                                {{ $getSize->size ?? '' }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('size'))
                                    ...
                                    <tbody class="sizevarientTable">
                                        @if (count($getProduct->size))
                                            @foreach ($getProduct->size_varient as $size)
                                                <tr class="{{ $size->id }}">
                                                    <td><input type="text" value="{{ $size->size }}"
                                                            placeholder="Product size"
                                                            class="form-control form-control-user" name="varient_size[]"
                                                            readonly></td>
                                                    <td><input type="text" value="{{ $size->price }}"
                                                            class="form-control form-control-user" name="price[]"
                                                            required></td>
                                                    <td><input type="text" value="{{ $size->gst }}"
                                                            class="form-control form-control-user" name="gst[]"
                                                            required></td>
                                                </tr>
                                            @endforeach
                                        @endif
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="Unit" type="text" placeholder="General Price"
                                        class="form-control form-control-user " name="general_price"
                                        value="{{ $getProduct->gen_price ?? '' }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="Unit" type="text" placeholder="General Gst %"
                                        class="form-control form-control-user " name="general_gst"
                                        value="{{ $getProduct->gen_gst ?? '' }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 " multiple="multiple" data-placeholder="Select a Area Of use"
                                        style="width: 100%;" name="areaOfuse[]">
                                        @foreach ($areaOfUses as $areaOf)
                                            <option value="{{ $areaOf->id ?? '' }}"
                                                @if (in_array($areaOf->id, $getProduct->area_of_use_id)) selected @endif>
                                                {{ $areaOf->area_of_use ?? '' }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 " multiple="multiple" data-placeholder="Select a Ideal for"
                                        style="width: 100%;" name="idealfor[]">
                                        @foreach ($idealFor as $ideal)
                                            <option value="{{ $ideal->id ?? '' }}"
                                                @if (in_array($ideal->id, $getProduct->ideal_for_id)) selected @endif>
                                                {{ $ideal->ideal_for ?? '' }}</option>
                                        @endforeach
                                    </select>
    ...
    @endif
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="form-group Recommended-check">
                                    <input id="Unit" type="checkbox" placeholder="Recommended"
                                        class="form-control-user checkbox" name="recommended" style="width:20px"
                                        @if ($getProduct->is_recommended) checked @endif>
            ...
            $('.varientValueList').on('select2:select', function() {
                ...
                selectedOptions.each(function() {
                    ...
                    var html = '<tr class="' + getType + '' + getTypeId +
                        '"><td><input type="text" value="' + getType +
                        '" placeholder="Product Name" class="form-control form-control-user" name="varient_name[]" readonly></td><td><input type="file" class="form-control form-control-user" name="varient_image[' +
                        getType +
                        '][]" multiple="multiple" accept=".png, .jpg, .jpeg" required></td></tr>';
            ...
            $('.sizevarientValueList').on('select2:select', function() {
                ...
                selectedOptions.each(function() {
                    ...
                    var html = '<tr class="' + getTypeId + '"><td><input type="text" value="' +
                        getType +
                        '" placeholder="Product size" class="form-control form-control-user" name="varient_size[]" readonly></td><td><input type="text" value="' +
                        price +
                        '" class="form-control form-control-user" name="price[]" required></td><td><input type="text" class="form-control form-control-user" value="' +
                        gst + '" name="gst[]" required></td></tr>';
