    ...
    <div class="side-bar">
        <div class="menu">
            <div class="item">
                ...
                <a href="{{ route('get.in.touch') }}" class="sub-btn nav-link dropdown-btns" id="crunch"> Get In
                    Touch </a>
                <a href="{{ route('work.with.us') }}" class="sub-btn nav-link dropdown-btns" id="crunch"> Work With
                    Us </a>
                <a href="{{ route('contact.us') }}" class="sub-btn nav-link dropdown-btns" id="crunch"> Contact Us
                </a>
                        ...
                        <div id="settingDrop" class="collapse" data-parent="#accordionSidebar">
                            <div class="card-body side-setting-dropdown">
                                <div>
                                    ...
                                    <a href="{{ route('size') }}" class="sub-btn nav-link" id="crunch">
                                        Size </a>
                                    <a href="{{ route('area.of.use') }}" class="sub-btn nav-link" id="crunch"> Area
                                        of Use </a>
                                    <a href="{{ route('material') }}" class="sub-btn nav-link" id="crunch"> Material
                                    </a>
                                    <a href="{{ route('ideal.for') }}" class="sub-btn nav-link" id="crunch"> Ideal
                                        For </a>
                                    <a href="{{ route('setting') }}" class="sub-btn nav-link" id="crunch"> Setting
                                    </a>
                                </div>
                            </div>
                        </div>
