        ...
        <div class="main-section-box">
            <div class="heading-box">
                <div class="backBtn">
                    ...
                    <h1 class="heading">Add Ideal For</h1>
                </div>
            </div>
            <div class="add-input-box">
                <form method="post" action="{{route('store.ideal.for')}}" id="add-color" enctype='multipart/form-data'>
                    @csrf
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="form-group">
                                <label class="form-label-box">Ideal For</label>
                                <input type="name" placeholder="Ideal For" class="form-control form-control-user" value="{{old('ideal_for')}}" name="ideal_for">
